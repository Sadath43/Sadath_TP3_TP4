...
class GameDao:
    ...
    def map_to_vessel_entities(self,battlefield_id: int,vessels:list[Vessel])-> list[VesselEntity]:
    ...
    def map_to_game(self,game_entity: GameEntity)-> game:
        ...
        return game
    def map_to_player(self,player_entity: PlayerEntity) -> player:
        ...
        return player
    def map_to_vessel(self,vessel_entity: VesselEntity) -> vessel:
        ...
        return vessel
    def map_to_battlefield(self,battlefield_entity:BattlefieldEntity) -> battlefield:
        ...
        return battlefield
    def map_to_battlefield_entity(self,battlefield: Battlefield) -> BattlefieldEntity:
